...
# =============================================================================
# BOFT 实验脚本 - GPU2
# 仅运行 GSM8K 数据集的 BOFT 实验
# 已完成: boft_llama2_7b_gsm8k_rank4, rank8, rank16, rank32 (各3个seed)
...
echo "========================================"
echo "BOFT Experiments - GSM8K (GPU2)"
echo "========================================"
echo ""
echo "已完成的实验 (已从列表中移除):"
echo "  - boft_llama2_7b_gsm8k_rank4 (seeds: 42, 1337, 2026)"
echo "  - boft_llama2_7b_gsm8k_rank8 (seeds: 42, 1337, 2026)"
echo "  - boft_llama2_7b_gsm8k_rank16 (seeds: 42, 1337, 2026)"
echo "  - boft_llama2_7b_gsm8k_rank32 (seeds: 42, 1337, 2026)"
echo ""
...
for config_name in "${configs[@]}"; do
    ...
    # 从配置名称中提取模型名称和数据集名称
    # 格式: boft_mistral_7b_gsm8k_rank4 -> mistral_7b_gsm8k
    IFS='_' read -ra parts <<< "$config_name"
    model_key="${parts[1]}_${parts[2]}_${parts[3]}"  # mistral_7b_gsm8k
