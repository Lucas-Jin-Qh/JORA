...
try:
    ...
    # diffusers may fail due to xformers/torch version mismatch in dev environments.
    # Only needed for vision-related tests. The JORA tests do not need diffusers.
